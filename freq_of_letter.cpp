#include <bits/stdc++.h> 
//really intresting library, only to use when you are competitor in coding chalange than a software engineer, when u have to prevent small size of program
using namespace std;
